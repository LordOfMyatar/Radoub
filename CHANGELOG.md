...
## [0.9.100] - TBD
**Branch**: `radoub/issue-1942` | **PR**: #TBD
...
- [x] #1849 — Replace methods for all search providers (DLG, UTC, UTI, UTM, JRL, GIT, Generic)
- [x] #1850 — BackupService (shadow files + archive backup with SHA256 verification)
- [x] #1851 — BatchReplaceService (preview, selective replace, backup, changelog)
- [x] #1852 — ToolDispatchService (resource type → tool mapping and launch)
- [x] #1853 — Replace UI in Parley (single-file Ctrl+H + module-wide replace)
...
## [0.9.92] - 2026-03-21
**Branch**: `radoub/issue-1821` | **PR**: #1887
...
- [x] #1393 - Bump coverlet.collector from 6.0.4 to 8.0.0
- [x] #1395 - Bump Avalonia and Avalonia.Controls.DataGrid 11.3.11 → 11.3.12
- [x] #1396 - Bump Avalonia and Avalonia.Diagnostics 11.3.11 → 11.3.12
- [x] #1397 - Bump Avalonia and Avalonia.Fonts.Inter 11.3.11 → 11.3.12
- [x] #1398 - Bump Avalonia.Headless.XUnit 11.3.11 → 11.3.12
- [x] #1399 - Bump Avalonia and Avalonia.Skia 11.3.11 → 11.3.12
...
- [x] #1283 - Complete IDisposable implementations across all tools
- [x] #1284 - Add error handling to fire-and-forget async calls
- [x] #1293 - Fix Parley StreamWriter leak, timer leak, and dispose cascade
...
## [0.9.61] - 2026-02-07
**Branch**: `radoub/issue-1262` | **PR**: #1266
