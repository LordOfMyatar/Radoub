...
{
    /// <summary>
    /// Manages theme loading, application, and switching for Manifest.
    /// Supports JSON-based theme plugins.
    /// </summary>
    public class ThemeManager
    {
        ...
        private void InitializeThemeDirectories()
        {
            ...
            var userThemes = Path.Combine(userProfile, "Radoub", "Manifest", "Themes");
        ...
        private void ApplyColors(IResourceDictionary resources, ThemeColors colors)
        {
            ...
            // Create Theme-prefixed resources for direct use
