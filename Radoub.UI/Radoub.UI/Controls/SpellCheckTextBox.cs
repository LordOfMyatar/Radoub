...
/// </summary>
/// <remarks>
/// Use this control for any player-facing text fields (names, descriptions, etc.)
/// that benefit from spell-checking. The control uses the shared SpellCheckService
/// which maintains a single dictionary instance across all Radoub tools.
/// </remarks>
public class SpellCheckTextBox : TextBox
{
    ...
    {
        // Recheck spelling when dictionaries are reloaded
        CheckSpelling();
    }
