...
/// Shared across all Radoub tools (Parley, Manifest, Quartermaster).
/// </summary>
...
/// <summary>
/// Theme color palette - superset of all tool-specific colors.
/// Tools only use the colors relevant to their UI.
/// </summary>
public class ThemeColors
{
    // Core UI colors (used by all tools)
    ...
    // Title bar colors (Parley, Manifest)
    ...
    // Spelling error underline color (Parley)
    [JsonPropertyName("spelling_error")]
    public string? SpellingError { get; set; }

    // Multi-NPC speaker colors (Parley)
