...
/// <summary>
/// Settings service for CreatureEditor.
/// Stores tool-specific settings in ~/Radoub/CreatureEditor/CreatureEditorSettings.json
...
public class SettingsService : INotifyPropertyChanged
{
    ...
    private static string SettingsDirectory
    {
        get
        {
            ...
            {
                var envDir = Environment.GetEnvironmentVariable("CREATUREEDITOR_SETTINGS_DIR");
                ...
                else
                {
                    ...
                    _settingsDirectory = Path.Combine(userProfile, "Radoub", "CreatureEditor");
                }
            }
    ...
    private static string SettingsFilePath => Path.Combine(SettingsDirectory, "CreatureEditorSettings.json");
    ...
    private string _currentThemeId = "org.creatureeditor.theme.light";
    ...
    {
        LoadSettings();
        UnifiedLogger.LogApplication(LogLevel.INFO, "CreatureEditor SettingsService initialized");
    }
    ...
    {
        get => _currentThemeId;
        set { if (SetProperty(ref _currentThemeId, value ?? "org.creatureeditor.theme.light")) SaveSettings(); }
    }
            ...
            if (File.Exists(SettingsFilePath))
            {
                ...
                if (settings != null)
                {
                    ...
                    _currentThemeId = !string.IsNullOrEmpty(settings.CurrentThemeId)
                        ...
                        : "org.creatureeditor.theme.light";
    ...
    private class SettingsData
    {
        ...
        public string CurrentThemeId { get; set; } = "org.creatureeditor.theme.light";
