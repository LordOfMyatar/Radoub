...
public partial class App : Application
{
    public override void Initialize()
    {
        ...
        if (!ThemeManager.Instance.ApplyTheme(themeId))
        {
            ...
            ThemeManager.Instance.ApplyTheme("org.creatureeditor.theme.light");
        }
    ...
    private static void RegisterToolPath()
    {
        try
        {
            ...
            {
                Radoub.Formats.Settings.RadoubSettings.Instance.CreatureEditorPath = exePath;
                UnifiedLogger.LogApplication(LogLevel.DEBUG, $"Registered CreatureEditor path in shared settings: {UnifiedLogger.SanitizePath(exePath)}");
            }
        }
        catch (Exception ex)
        {
