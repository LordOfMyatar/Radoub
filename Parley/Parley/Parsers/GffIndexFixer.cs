...
namespace DialogEditor.Parsers
{
    ...
    public class GffIndexFixer
    {
        ...
        {
            UnifiedLogger.LogParser(LogLevel.INFO, $"🎯 FixCompactPointerStructFieldIndices: Updating {compactResult.UniquePointers.Count} compact pointer structs");
            ...
            UnifiedLogger.LogParser(LogLevel.INFO, $"✅ Updated {compactResult.UniquePointers.Count} compact pointer struct field indices");
        }
        ...
        {
            UnifiedLogger.LogParser(LogLevel.INFO, $"🎯 FixDirectPointerStructFieldIndices: Updating {structCount} pointer structs starting at struct[{structStartIndex}]");
            ...
            UnifiedLogger.LogParser(LogLevel.INFO, $"✅ Updated {structCount} pointer struct field indices");
        }
        ...
        {
            UnifiedLogger.LogParser(LogLevel.INFO, $"🎯 FixReplyPointerStructFieldIndices: Updating struct DataOrDataOffset values (append-only method)");
        ...
        {
            UnifiedLogger.LogParser(LogLevel.INFO, $"🎯 FixStartWrapperStructFieldIndices: Updating struct DataOrDataOffset values for Start wrapper structs");
        ...
        {
            UnifiedLogger.LogParser(LogLevel.INFO, $"🎯 FixEntryPointerStructFieldIndices: Updating struct DataOrDataOffset values");
