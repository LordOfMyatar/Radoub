...
public class DlgSearchProvider : SearchProviderBase, IFileSearchProvider
{
    ...
    private static readonly FieldDefinition SoundField = new() { Name = "Sound", GffPath = "Sound", FieldType = SearchFieldType.ResRef, Category = SearchFieldCategory.Metadata, Description = "Sound file reference", IsReplaceable = false };
